<<?php
    ...
    if(isset($_POST['edit_homework'])){
        $query = "UPDATE homwork SET s_id='$_POST[id]',description='$_POST[description]',start_date='$_POST[start_date]',end_date='$_POST[end_date]' WHERE hid='$_GET[id]'";
...
<body>
    ...
    <div class="row">
        <div class="col-md-4 m-auto" style="color:white;"><br>
            <h3 style="color:white;">edit the homework</h3>
            <?php 
                session_start();
